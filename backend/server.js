...
// Trust proxy for secure rate limiting behind reverse proxies (Render, AWS ALB, etc.)
...
// Base route
app.get('/', (req, res) => {
  res.json({ message: 'Welcome to FoodForMe API' });
});
...
// Ensure single app.listen call to avoid port conflicts
